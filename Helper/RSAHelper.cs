...
public class RsaHelper
{
    ...
    public RsaHelper(string privateKey = "", string publicKey = "", RsaType rsaType = RsaType.Rsa)
    {
        ...
        {
            throw new BusException("RSA private key or public key cannot be empty");
        }
    ...
    public string Decrypt(string cipherText)
    {
        ...
        {
            throw new BusException("_privateKeyRsaProvider is null");
        }
    ...
    public string Encrypt(string text)
    {
        ...
        {
            throw new BusException("_publicKeyRsaProvider is null");
        }
    ...
    public RSA CreateRsaProviderFromPrivateKey(string privateKey)
    {
        ...
        using (BinaryReader binr = new BinaryReader(new MemoryStream(privateKeyBits)))
        {
            ...
            if (twobytes == 0x8130)
                ...
                throw new BusException("Unexpected value read binr.ReadUInt16()");

            twobytes = binr.ReadUInt16();
            if (twobytes != 0x0102)
                throw new BusException("Unexpected version");

            bt = binr.ReadByte();
            if (bt != 0x00)
                throw new BusException("Unexpected value read binr.ReadByte()");
